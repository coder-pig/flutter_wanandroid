...
class IndexArticleInfo {
  ...
  IndexArticleInfo(this.curPage,this.datas,this.offset,this.over,this.pageCount,this.size,this.total,);

  factory IndexArticleInfo.fromJson(Map<String, dynamic> srcJson) => _$IndexArticleInfoFromJson(srcJson);
